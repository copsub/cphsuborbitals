<?php
/*
Template Name: Forside template 1
*/
?>
...
<?php get_header(); 
  ...
  $image        =  get_field( '_frontpage_template_1_picture', $post->ID ); 
...
<div class="frontpage template_1" style="background-image:url('<?php echo $image_url; ?>'); background-size:<?php echo $image_width; ?>px <?php echo $image_height; ?>px;" data-image-url="<?php echo $image_url; ?>">
  
  <div class="table first template_1">
     <div class="tr">
        <div class="td">
              ...
              <div class="table">
                 <div class="tr">
                        <div class="td">
                            <div class="support_us"><a href="/support-us">support us</a><span></span></div>
                        </div>    
                        <div class="td">
                            <div class="watch_us"><a rel="wp-video-lightbox" href="https://www.youtube.com/watch?v=<?php echo $video_id; ?>&amp;width=640&amp;height=480" title="" onclick="_gaq.push(['_trackEvent','Main Page','Click','Watch Us Video']);">Watch Intro</a><span></span></div>
                     </div>    
                  </div>
               </div>
       </div>
